...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>User Login | webExplore</title>
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
    <form class="login-form">
      ...
      <div class="row">
        <div class="input-field col s12">
          <a href="javascript:;" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12" id="loginBtn">Login</a>
        </div>
      </div>
      <!-- <div class="row">
    ...
    <script src="<?php echo base_url(); ?>assets/js/custom/admin_login/login.js"></script>
    <!-- END THEME  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <!-- END PAGE LEVEL JS-->
